...
#include "amr_msgs/msg/detail/location__rosidl_typesupport_fastrtps_c.h"
...
using _Location__ros_msg_type = amr_msgs__msg__Location;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amr_msgs__msg__Location;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const amr_msgs__msg__Location * ros_message = static_cast<const amr_msgs__msg__Location *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_amr_msgs__msg__Location(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  amr_msgs__msg__Location * ros_message = static_cast<amr_msgs__msg__Location *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_amr_msgs__msg__Location(cdr, ros_message);
}

static uint32_t _Location__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_amr_msgs__msg__Location(
...
static size_t _Location__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_amr_msgs__msg__Location(
