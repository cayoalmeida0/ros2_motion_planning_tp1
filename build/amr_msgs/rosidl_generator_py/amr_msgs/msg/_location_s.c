...
bool amr_msgs__msg__location__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("amr_msgs.msg._location.Location", full_classname_dest, 31) == 0);
  }
  amr_msgs__msg__Location * ros_message = _ros_message;
  {  // x
...
PyObject * amr_msgs__msg__location__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("amr_msgs.msg._location");
